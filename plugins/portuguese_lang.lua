...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		set_text(LANG, 'botsT', 'Bots são permitidos neste chat.')
		set_text(LANG, 'botsL', 'Bots são permitidos neste supergrupo.')
		set_text(LANG, 'noBotsT', 'Bots não são permitidos neste chat.')
		set_text(LANG, 'noBotsL', 'Bots não são permitidos neste supergrupo.')
